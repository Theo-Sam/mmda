...
import { Building2, Eye, EyeOff, Loader2, Shield, Moon, Sun, UserCog, User, Briefcase, Users, FileText, Globe, Building, UserCheck, UserCircle, Lock as LockIcon, Info } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900 dark:text-white">MMDA Revenue System</h1>
                <p className="text-sm text-gray-500 dark:text-gray-400">Metropolitan Management System</p>
              </div>
            </div>
                  ...
                  <div key={user.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-500">{user.district}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-sm font-mono text-blue-600 dark:text-blue-400">{user.email}</p>
